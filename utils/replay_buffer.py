...
class ReplayBuffer(object):
    def __init__(self,
        ...
        self.observations = self._build(self.observation_space)
        self.actions = self._build(self.action_space)
        self.next_observations = self._build(self.observation_space)
